...
class VideoGrid {
    ...
    /**
     * Gen. Video Grid from DB
     *
     * Get a 15 random rows from the video table as an assoc-array
     * for every row, pass it to a new Video object and with that object
     * create a VideoGridItem object and with it create the video card component
     * and concatenate it to elementsHtml.
     */
    ...
    /**
     * Gen. Video Grid from $videos arrray
     *
     *
     */
